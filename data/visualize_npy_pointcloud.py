...
if __name__ == "__main__":
    # Example usage
    npy_paths = ["data/my_pointcloud/hole_pointcloud_filtered_1_scaled.npy", "data/my_pointcloud/hole_pointcloud_filtered_1_scaled_transform.npy"]
    visualize_multiple_npy_point_clouds(npy_paths)
    npy_paths = ["ref_demo.npy", "src_transform_demo.npy"]
    visualize_multiple_npy_point_clouds(npy_paths)