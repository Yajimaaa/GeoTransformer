...
class GeometricStructureEmbedding(nn.Module):
    ...
    def get_embedding_indices(self, points):
        ...
        k = self.angle_k # k is set to "3" in this file -> /home/masaruy/workspace/GeoTransformer/experiments/geotransformer.3dmatch.stage4.gse.k3.max.oacl.stage2.sinkhorn/config.py 
        N = dist_map.shape[1]
        if N < 4:
            print(f"N = {N}")
        if k+1 > N:
